...
/*   Updated: 2025/04/07 08:38:40 by dcaetano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

const unsigned int ScavTrap::__MAX_HIT_POINTS = 100;
const unsigned int ScavTrap::__MAX_ENERGY_POINTS = 50;
const unsigned int ScavTrap::__MAX_ATTACK_DAMAGE = 20;

ScavTrap::ScavTrap(void) : ClapTrap()
{
	std::cout << "ScavTrap default constructor called" << std::endl;
	this->_hitPoints = ScavTrap::__MAX_HIT_POINTS;
	this->_energyPoints = ScavTrap::__MAX_ENERGY_POINTS;
	this->_attackDamage = ScavTrap::__MAX_ATTACK_DAMAGE;
}
